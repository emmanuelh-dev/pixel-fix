...
export const salesCatalog = [
  {
    ...
    id: "pixel-10",
    devices: [
      { name: "Google Pixel 10 Pro XL", specs: "128GB / 16GB RAM - Nuevo Sellado", price: "$16,000 MXN", availability: "Importación 10-12 días hábiles", color: "Obsidian / Porcelain" },
      { name: "Google Pixel 10", specs: "128GB / 12GB RAM - Nuevo Sellado", price: "$14,000 MXN", availability: "Importación 10-12 días hábiles", color: "Hazel" }
    ]
  },
  {
    series: "Pixel 9 Series",
    id: "pixel-9",
    devices: [
      { name: "Google Pixel 9 Pro XL", specs: "128GB / 16GB RAM - Nuevo Sellado", price: "$18,500 MXN", availability: "Importación 10-12 días hábiles", color: "Obsidian / Porcelain" },
      { name: "Google Pixel 9 Pro", specs: "128GB / 16GB RAM - Nuevo Sellado", price: "$15,500 MXN", availability: "Importación 10-12 días hábiles", color: "Hazel" },
      { name: "Google Pixel 9", specs: "128GB / 12GB RAM - Nuevo Sellado", price: "$11,500 MXN", availability: "Importación 10-12 días hábiles", color: "Wintergreen" }
    ]
  },
  {
    series: "Pixel 8 Series",
    id: "pixel-8",
    devices: [
      { name: "Google Pixel 8 Pro", specs: "128GB / 12GB RAM - Reacondicionado Grado A", price: "$7,500 MXN", availability: "Importación 10-12 días hábiles", color: "Bay Blue" },
      { name: "Google Pixel 8", specs: "128GB / 8GB RAM - Reacondicionado Grado A", price: "$4,500 MXN", availability: "Importación 10-12 días hábiles", color: "Rose" }
    ]
  },
  {
    series: "Pixel 7 Series",
    id: "pixel-7",
    devices: [
      { name: "Google Pixel 7 Pro", specs: "128GB / 12GB RAM - Reacondicionado Grado A", price: "$3,500 MXN", availability: "Importación 10-12 días hábiles", color: "Hazel" },
      { name: "Google Pixel 7", specs: "128GB / 8GB RAM - Reacondicionado Grado A", price: "$1,500 MXN", availability: "Importación 10-12 días hábiles", color: "Lemongrass" }
    ]
  }
];
